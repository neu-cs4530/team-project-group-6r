...
export default class PostCoveyTownController extends CoveyTownController {
  ...
  // Add
  /**
   * Creates a post in this coveytown, detects area collision and avoids post coordinates collision.
  ...
  async createComment(comment: Comment): Promise<Comment> {
    ...
    this._listeners.forEach(listener => listener.onCommentUpdate(result.rootPostID, comments));
